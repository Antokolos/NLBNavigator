...
public:
    ...
    std::filesystem::path getRootDir() const override;
    std::filesystem::path getImagesDir() const override;
    std::set<std::string> getUsedImages() const override;
    std::set<std::string> getUsedSounds() const override;
    std::vector<std::shared_ptr<MediaFile>> getImageFiles() const override;
    std::vector<std::shared_ptr<MediaFile>> getSoundFiles() const override;
